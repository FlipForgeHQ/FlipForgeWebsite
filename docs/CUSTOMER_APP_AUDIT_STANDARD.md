...
2. Authenticated customer shell
3. Authorized tenant data
4. Empty data
5. Invalid or unavailable upstream data
6. Mobile viewport
7. Desktop viewport
...
- The anonymous sign-in control must remain inside the viewport on desktop and mobile.
- The anonymous sign-in control must disappear after a real authenticated identity is established.
