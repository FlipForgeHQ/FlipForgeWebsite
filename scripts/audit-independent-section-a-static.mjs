...
// A1 — required acquisition/public pages exist in the shipped source tree.
...
// A2 — locked brand language on customer-facing pages.
const retiredBrand = [
...
// A3 — current private-beta commercial boundary.
...
// A4 — local links/assets resolve, and public pages do not contain stale staging/prototype endpoints.
const broken = [];
const stale = [];
