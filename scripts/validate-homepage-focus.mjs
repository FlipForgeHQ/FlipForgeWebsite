...
check('006 hero explains the exact-card difference',index.includes('FlipForge checks the exact sports-card identity')&&index.includes('validates the comparisons behind its price'));
check('007 hero primary CTA opens the proof',index.includes('decision-button-primary" href="#deal-or-decoy" data-ff-see-action>See FlipForge in Action'));
