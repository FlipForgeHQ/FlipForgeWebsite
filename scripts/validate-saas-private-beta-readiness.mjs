...
[
  ...
  ["038 remaining sample routes are disclosed", ["Discover", "Portfolio", "Sell", "Alerts"].every(value => beta.includes(value)) && !beta.includes("Dashboard, Discover, Portfolio") && beta.includes("Dashboard → Evaluate")],
  ...
  ["059 docs identify real Dashboard and incomplete sample routes", docs.includes("Dashboard, Evaluate, Opportunities") && docs.includes("Discover, Portfolio, Sell, and Alerts") && docs.includes("Decision Traceback, Compare, evidence")],
