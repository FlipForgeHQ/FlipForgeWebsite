...
requireText('homepage value explanation',homepage,'Bad comps can make a bad deal look good.');
requireText('homepage value explanation',homepage,'FlipForge verifies the exact card');
requireText('homepage value explanation',homepage,'shows what the price actually supports.');
...
requireText('homepage illustrative boundary',homepage,'Illustrative example');
requireText('homepage illustrative boundary',homepage,'not live market data');
...
requireText('homepage film explainer',homepage,'WHAT FLIPFORGE IS DOING');
requireText('homepage film explainer',filmJs,'renderExplanation');
