...
if (!index.includes('The price is easy.') || !index.includes('Knowing whether to trust it isn’t.')) homepageFailures.push('approved v5 attention hook');
if (!index.includes('A decision you can not only trust, but understand.')) homepageFailures.push('core product promise');
...
if (index.includes('CARD VALUE INTELLIGENCE')) homepageFailures.push('retired formal Card Value Intelligence descriptor removed');
