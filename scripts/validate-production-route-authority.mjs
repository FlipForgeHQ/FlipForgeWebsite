...
check("Show me why deterministically opens the saved Evidence Center", saveFlow.includes("function openDecisionEvidence()") && saveFlow.includes('[data-ff-show-why]') && saveFlow.includes('window.location.hash = `#/evidence/${encodeURIComponent(id)}`') && !saveFlow.includes("focusDecisionWhy"));
