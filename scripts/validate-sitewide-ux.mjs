...
const routeStabilityCss=read('saas-prototype/customer-route-stability-v1.css');
const routeStabilityJs=read('saas-prototype/customer-route-stability-v1.js');
...
requireText('dashboard CSS is preloaded before route paint',appIndex,'<link rel="stylesheet" href="commercial-dashboard-v2.css">');
