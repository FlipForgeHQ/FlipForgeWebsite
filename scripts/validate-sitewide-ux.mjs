...
requireText('homepage live process owns evidence qualification story',dealProcess,'.ff-process-evidence-flow');
requireText('homepage live process owns value correction',dealProcess,'[data-ff-supported-value]');
...
requireText('homepage direct first action',homepage,'Would you pay <span>$349</span>?');
...
requireText('homepage animates evidence qualification',dealJs,"evidenceKept.textContent='2'");
...
requireText('homepage result after processing',dealJs,'schedule(token,3600,showResult)');
