(() => {
  ...
  function recoveredListMarkup(payload) {
    ...
    return `<div class="page customer-intelligence-page" data-saved-intelligence-recovery>
      ...
      <div class="boundary-note"><strong>Recovered customer view:</strong> FlipForge loaded the authoritative saved-decision list directly instead of blocking on optional dashboard preflight data. No mock record or browser-generated recommendation was substituted.</div>
