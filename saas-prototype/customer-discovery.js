(() => {
  ...
  function candidateCard(item, index) {
    ...
    const best = item.eligibleForBestConnectedCandidate === true;
    const label = best ? "Best connected candidate" : String(item.discoveryLabel || "Connected candidate").replaceAll("_", " ");
