  ...
  function pageMarkup(session, health) {
    ...
    return `<div class="page private-beta-page" data-private-beta-readiness>
      <header class="page-heading">
        ...
        <div class="page-actions"><a class="button button-primary" href="#/evaluate" data-private-beta-start>Start an evaluation</a></div>
      </header>

      <div class="boundary-note"><strong>Beta boundary:</strong> Smart Opportunity remains the sole recommendation authority, Existing PSA intelligence remains the sole grading-guidance authority, and SQLite remains the source of truth. No public signup, billing, paid entitlement, provider administration, or transaction execution is active.</div>

      <section class="panel private-beta-hero">
        <div class="panel-body">
          <div class="private-beta-hero-copy"><span class="eyebrow">Welcome, ${escapeHtml(displayName)}</span><h2>Evaluate one card. Follow the evidence. Challenge the explanation.</h2><p>The goal of this beta is not to test another price chart. It is to test whether FlipForge makes the reasoning behind a card decision clear, traceable, and useful before you buy.</p></div>
        ...
        <div class="stack">
          <section class="panel">
            ...
            <div class="panel-body private-beta-steps">
              ...
              <div class="private-beta-step"><span class="private-beta-step-number">5</span><span class="private-beta-step-copy"><span>Manage</span><strong>Review Evidence, PSA, and exit context</strong><small>Inspect saved evidence history, saved PSA requirements, and exit-planning inputs without creating a new recommendation.</small></span><a class="button button-secondary" href="#/evidence">Manage</a></div>
              <div class="private-beta-step"><span class="private-beta-step-number">6</span><span class="private-beta-step-copy"><span>Export</span><strong>Create a Decision Dossier</strong><small>Package the saved decision, governed evidence, PSA context, and lifecycle history with a SHA-256 integrity manifest.</small></span><a class="button button-secondary" href="#/export">Export</a></div>
              <div class="private-beta-step"><span class="private-beta-step-number">7</span><span class="private-beta-step-copy"><span>Report</span><strong>Send focused feedback</strong><small>Tell us what was clear, what was missing, and what would have changed your decision.</small></span><button class="button button-secondary" type="button" data-private-beta-feedback-link>Feedback</button></div>
            </div>
          </section>
