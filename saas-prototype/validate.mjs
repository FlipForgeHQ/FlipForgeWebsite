...
check("004 customer brand identity is present", files.index.includes("CARD DECISION INTELLIGENCE"));
...
check("067 Card Decision Intelligence is the visible identity line", files.index.includes('<span class="brand-subtitle">CARD DECISION INTELLIGENCE</span>'));
...
check("078 website build replaces the deprecated tagline with the current descriptor", files.websiteBuild.includes("'Signal. Confidence. Advantage.'") && files.websiteBuild.includes("'Card Decision Intelligence'"));
