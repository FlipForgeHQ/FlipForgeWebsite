(() => {
  ...
  const COPY_REPLACEMENTS = [
    ...
    ["Authenticated tenant-scoped intelligence · Saved decisions · No transaction authority", "Card Decision Intelligence™ workspace · Evaluation only"],
    ["Controlled customer intelligence preview · No transaction authority", "Card Decision Intelligence™ preview · Evaluation only"],
    ["Controlled customer intelligence · No transaction authority", "Card Decision Intelligence™ workspace · Evaluation only"],
